...
export class FtpModel {
	...
	constructor(public readonly host: string, private user: string, private password: string) {
	}
...
export class FtpTreeDataProvider implements
	vscode.TreeDataProvider<FtpNode>, vscode.TextDocumentContentProvider {
